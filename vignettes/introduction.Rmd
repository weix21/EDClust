...
After computing the initial values, 

```{r clustering, eval = FALSE}
result <- FitPolya(count_all_notna, subject_all_notna, alpha_0)
```

Based on the clustering result, we can benchmark the performance of EDClust with ARI. And The t-SNE plot can be shown as: 
