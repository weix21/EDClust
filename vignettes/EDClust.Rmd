...
```{r initialization, eval = TRUE, message=FALSE, results='hide', include = TRUE}
...
```{r clustering, eval = TRUE, message=FALSE, results='hide', include = TRUE}
...
```{r ARI, eval = TRUE, message=FALSE, results='hide', include = TRUE}
library(mclust)
