...
#'   \item delta: a list of subject-type specific effects estimates
#'   \item alpha: a list of overall effects estimates
...
#'
#' EMMM_Result <- FitPolya(count_all_notna, subject_all_notna, alpha_0,
#'                         EM_steps = 20L, MM_steps = 5L, flag = 1e-05)
#'
#'
FitPolya <- function(count_all_notna, subject_all_notna, alpha_0, EM_steps = 100L, MM_steps = 3L, flag = 1e-04) {
  EMMM_Result <- julia$call("fitPolya", count_all_notna, subject_all_notna, alpha_0, EM_steps, MM_steps, flag)
